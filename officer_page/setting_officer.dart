...
class setting_officer extends StatefulWidget {
  @override
  MapScreenState createState() => MapScreenState();
}

class MapScreenState extends State<setting_officer>
  ...
  TextEditingController _duty_controler = TextEditingController();
  ...
  var current_uu_id = FirebaseAuth.instance.currentUser!.uid;
  @override
            ...
            children: <Widget>[
              Column(
                children: <Widget>[
                  ...
                  my_files(current_uu_id, "Officers"),
                  //show_my_setting()
                ],
              ),
            ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            !_status ? _getActionButtons(current_uu_id) : Container(),
          ],
        ),
      ),
    );
  ...
  Widget _getActionButtons(String current_uu_id) {
    return Padding(
                ...
                onPressed: () {
                  setState(() {
                    ...
                    Map<String, dynamic> update_mystatus = {
                      ...
                      "phone": _mobile_controler.text,
                      "duty": _duty_controler.text
                    };
  ...
  FutureBuilder<DocumentSnapshot<Map<String, dynamic>>> my_files(
      String current_uu_id, String database_lcocation) {
    return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      future: FirebaseFirestore.instance
          .collection(database_lcocation)
          .doc(current_uu_id)
          .get(),
      builder: (_, snapshot) {
        ...
        if (snapshot.hasData) {
          ...
          _duty_controler.text = data["duty"].toString();
